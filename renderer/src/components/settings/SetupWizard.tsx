...
const STEPS = ['Workspace', 'Provider', 'Tools', 'Ready'];
        ...
        <div style={styles.stepper}>
          {STEPS.map((label, i) => (
            <div key={label} style={styles.step}>
              <div style={{
                ...styles.stepDot,
                backgroundColor: i <= step ? '#2563eb' : '#e5e8ec',
                color: i <= step ? '#fff' : '#8a929d',
              }}>
                {i < step ? '✓' : i + 1}
              </div>
              <div style={{
                ...styles.stepLabel,
                color: i <= step ? '#303741' : '#8a929d',
              }}>
                {label}
              </div>
              {i < STEPS.length - 1 && (
                <div style={{
                  ...
                  backgroundColor: i < step ? '#2563eb' : '#dfe3e8',
                }} />
              )}
            </div>
          ))}
        ...
        <div style={styles.body}>
          ...
          {step === 0 && (
            <div>
              ...
              <p style={styles.hint}>
                The desktop can show designs generated by Claude Code, Codex, or the built-in chat workflow.
                Leave this blank to use the repository-local default workspace.
              </p>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  title: { color: '#2563eb', fontSize: 20, margin: '0 0 6px' },
  subtitle: { color: '#69727d', fontSize: 13, margin: 0 },
  loading: { color: '#69727d', textAlign: 'center', padding: 40 },
  loadingError: { color: '#a32d38', textAlign: 'center', padding: 40 },
  errorMsg: {
  ...
  summaryLabel: { fontSize: 12, color: '#69727d' },
  summaryValue: { fontSize: 12, color: '#303741', fontFamily: "'Cascadia Code', 'Consolas', monospace", wordBreak: 'break-all' },
  hint: { fontSize: 12, color: '#7b8490', fontStyle: 'italic' },
  footer: {
    display: 'flex',
    justifyContent: 'space-between',
    padding: '12px 32px',
