...
const right = readFileSync('prototype/ldo_grid.svg', 'utf8');
...
<div style="display:flex;gap:16px;padding:16px;align-items:flex-start">
  ...
  <div style="flex:1">
    <div style="font-size:22px;font-weight:700;color:#267346;margin-bottom:8px">AI grid prototype — 0 overlaps, 4 crossings, 0 intrusions</div>
